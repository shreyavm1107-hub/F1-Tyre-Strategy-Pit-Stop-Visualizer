...
# IMPORTANT: Streamlit Community Cloud mounts the app's source folder
# (/mount/src/...) as READ-ONLY. A cache folder created relative to the app
# directory (e.g. "f1_cache") will fail to write there, which causes
# session.load() to silently leave data unpopulated -> DataNotLoadedError.
# We use the OS temp directory instead, which is always writable.
# ----------------------------------------------------------------------------
